...
public class PerlinNoise {
	public float perlinNoise(float x, float y) {
		Noisy noisy = new Noisy(9001, 7, 1.0f);
		
		return 5.0f * noisy.perlinNoise2D(x, y);
	}
}

//class below made by warmwaffles, available on his github page with free use
//much smoother than my own implementation on perlin noise
 class Noisy {
	public int seed;
